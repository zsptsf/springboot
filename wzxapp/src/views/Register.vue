    ...
    <div class="me-login-box me-login-box-radius">
      ...
      <el-form ref="userForm" :model="userForm" :rules="rules">
        <el-form-item prop="number">
          <el-input placeholder="账号" v-model="userForm.number"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="password">
          <el-input placeholder="密码" v-model="userForm.password" autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item size="small" class="me-login-button">
          <el-button type="primary" @click.native.prevent="register('userForm')">注册并登录</el-button>
        </el-form-item>
      </el-form>
        ...
        this.$refs[formName].validate((valid) => {//表单验证
          if (valid) {
            ...
            that.$store.dispatch('register', that.userForm).then(() => {
              that.$message({message: '注册新账号登录成功', type: 'success', showClose: true});
